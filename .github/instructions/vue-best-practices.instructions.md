---
applyTo: "**/*.vue,**/*Model.ts,**/use*.ts"
---

<!-- Generated by Export-AgentSkills.ps1 from the vue-best-practices skill's RULES.md. Do not edit:
...
---
*The reasoning, the loop and the worked examples are in the `vue-best-practices` skill at `.claude/skills/vue-best-practices/SKILL.md`. This file is the part that must hold.*
